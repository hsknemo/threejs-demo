...
import cube from "./model/smoke/cube";
import smokePointLayer from "./model/smoke/smokePoint.js";
window.camera = null;
window.scene = null;
...
window.sceneConfig = {
  cube,
  smokePointLayer: smokePointLayer,
};
...
function initSceneMesh(scene) {
  ...
  window.sceneConfig.smokePointLayer.layout(scene);
}
...
function animate() {
  ...
  controls.update();
  sceneConfig.smokePointLayer.update();
